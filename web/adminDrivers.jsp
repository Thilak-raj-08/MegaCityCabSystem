...
<body class="text-gray-800 font-inter">
    ...
    <div id="driverModal" class="hidden fixed inset-0 z-50 overflow-y-auto">
        ...
        <div class="flex min-h-screen items-center justify-center p-4">
            <div class="relative w-full max-w-2xl bg-white rounded-lg shadow-xl">
                ...
                <form method="POST" action="AdminDriversServlet" class="p-6 space-y-6">
    ...
    <script>
        ...
        function editDriver(driverId, fullName, licenseNumber, phone, address, status) {
            toggleModal('edit');
        ...
        function deleteDriver(driverId) {
            if (confirm('Are you sure you want to delete this driver?')) {
                window.location.href = 'AdminDriversServlet?action=delete&driverId=' + driverId;
            }
        }
    </script>
